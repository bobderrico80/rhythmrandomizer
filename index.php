...
<html>
    ...
    <body>
        <div class="banner">
            <img src="img/hamburger.png" title="Options" class="optionsButton" alt="options"/>
            <h1>The Rhythm Randomizer</h1>
        </div>
        <div class="options">
            <div class="generalOptionsTab optionTabs">
                <div class="rightArrow"></div>
                <div class="optionsTabLabel">General Options</div>
            </div>
            <div class="generalOptions optionsPage">
            ...
            <div class="noteOptionsTab optionTabs">
                <div class="downArrow"></div>
                <div class="optionsTabLabel">Note Options</div>
            </div>
            <?php
        ...
        <div class="rhythmContainer" title="Click the rhythm to generate a new one!">
            <div class="preloader">
